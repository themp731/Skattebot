...
## Week 12 Update - Generated November 27, 2025 at 05:26 AM
...
|------|--------|-----------|------------------|--------------|----------------|----------------|
| MP | 9-3 | 99.2% | 11 | 1699 | #1.3 | 80.7% |
| ZSF | 7-5 | 76.2% | 9 | 1683 | #3.3 | 8.1% |
| sgf | 8-4 | 73.5% | 9 | 1630 | #3.4 | 7.0% |
| KIRK | 7-5 | 60.8% | 9 | 1600 | #4.2 | 1.2% |
| POO | 7-5 | 51.9% | 9 | 1557 | #4.3 | 1.9% |
| GV | 7-5 | 35.4% | 9 | 1547 | #4.9 | 1.1% |
| PATS | 5-7 | 1.8% | 7 | 1587 | #7.7 | 0.0% |
| GEMP | 6-6 | 1.3% | 7 | 1435 | #7.7 | 0.0% |
| KESS | 5-7 | 0.0% | 6 | 1411 | #8.9 | 0.0% |
...
**Projection Summary:** Most likely finish: **11 wins** | Projected PF: **1699** | Playoff: **99.2%** | #1 Seed: **80.7%** 
...
| **Optimized** | **94.2 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 103.0 | 86.7 | 
| Corrected (BYE/Inj=0) | 78.7 | 69.4 | 
| **Optimized (+Bench)** | **87.7** | **85.4** | 
...
| Corrected (BYE/Inj=0) | 101.8 | 101.2 | 
| **Optimized (+Bench)** | **101.8** | **101.2** | 
...
**Projection Summary:** Most likely finish: **9 wins** | Projected PF: **1630** | Playoff: **73.5%** | #1 Seed: **7.0%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 81.3 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **76.2 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 93.5 | 98.7 | 
| Corrected (BYE/Inj=0) | 77.4 | 72.1 | 
| **Optimized (+Bench)** | **77.4** | **91.3** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 50.7 | 101.3 | 
| Corrected (BYE/Inj=0) | 45.5 | 93.1 | 
| **Optimized (+Bench)** | **56.7** | **93.1** | 
...
**Projection Summary:** Most likely finish: **9 wins** | Projected PF: **1683** | Playoff: **76.2%** | #1 Seed: **8.1%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 98.7 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **90.7 pts** | ESPN Raw - unavailable + bench subs | 
...
| Corrected (BYE/Inj=0) | 64.0 | 83.1 | 
| **Optimized (+Bench)** | **80.9** | **93.6** | 
...
**Projection Summary:** Most likely finish: **9 wins** | Projected PF: **1600** | Playoff: **60.8%** | #1 Seed: **1.2%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 104.3 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **86.2 pts** | ESPN Raw - unavailable + bench subs | 
| Historical PPG | 109.4 pts | Season average through week 12 | 
| Monte Carlo Input | 95.4 pts | 60% Optimized + 40% Historical | 

*Right on the knife's edge at 61%. ESPN projects enough points to stay competitive, but so does everyone else.* 
...
|-----------------|--------|----------| 
| ESPN Raw | 106.7 | 80.6 | 
| Corrected (BYE/Inj=0) | 52.2 | 70.2 | 
| **Optimized (+Bench)** | **52.2** | **87.8** | 
...
On the playoff bubble at #5 with 7-5. Need to step it up - only 35.4% playoff odds right now. Their 104.92 PPG and 7 top-6 finishes show potential. 

**Projection Summary:** Most likely finish: **9 wins** | Projected PF: **1547** | Playoff: **35.4%** | #1 Seed: **1.1%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 96.2 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **89.9 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 98.7 | 93.5 | 
| Corrected (BYE/Inj=0) | 72.1 | 77.4 | 
| **Optimized (+Bench)** | **91.3** | **77.4** | 
...
**Projection Summary:** Most likely finish: **9 wins** | Projected PF: **1557** | Playoff: **51.9%** | #1 Seed: **1.9%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 104.0 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **90.8 pts** | ESPN Raw - unavailable + bench subs | 
| Historical PPG | 105.6 pts | Season average through week 12 | 
| Monte Carlo Input | 96.7 pts | 60% Optimized + 40% Historical | 

*Right on the knife's edge at 52%. ESPN projects enough points to stay competitive, but so does everyone else.* 
...
|-----------------|--------|----------| 
| ESPN Raw | 109.5 | 84.7 | 
| Corrected (BYE/Inj=0) | 66.7 | 33.1 | 
| **Optimized (+Bench)** | **78.0** | **45.1** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 101.3 | 50.7 | 
| Corrected (BYE/Inj=0) | 93.1 | 45.5 | 
| **Optimized (+Bench)** | **93.1** | **56.7** | 
...
| Corrected (BYE/Inj=0) | 101.2 | 101.8 | 
| **Optimized (+Bench)** | **101.2** | **101.8** | 
...
**Projection Summary:** Most likely finish: **7 wins** | Projected PF: **1587** | Playoff: **1.8%** | #1 Seed: **0.0%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 94.4 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **86.6 pts** | ESPN Raw - unavailable + bench subs | 
...
| Corrected (BYE/Inj=0) | 83.1 | 64.0 | 
| **Optimized (+Bench)** | **93.6** | **80.9** | 
...
**Projection Summary:** Most likely finish: **7 wins** | Projected PF: **1435** | Playoff: **1.3%** | #1 Seed: **0.0%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 83.6 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **78.3 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 86.7 | 103.0 | 
| Corrected (BYE/Inj=0) | 69.4 | 78.7 | 
| **Optimized (+Bench)** | **85.4** | **87.7** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 84.3 | 86.1 | 
| Corrected (BYE/Inj=0) | 76.8 | 75.8 | 
| **Optimized (+Bench)** | **76.8** | **84.6** | 
...
**Projection Summary:** Most likely finish: **6 wins** | Projected PF: **1415** | Playoff: **0.0%** | #1 Seed: **0.0%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 88.6 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **84.8 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 87.3 | 90.4 | 
| Corrected (BYE/Inj=0) | 82.0 | 67.7 | 
| **Optimized (+Bench)** | **82.0** | **67.7** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 86.1 | 84.3 | 
| Corrected (BYE/Inj=0) | 75.8 | 76.8 | 
| **Optimized (+Bench)** | **84.6** | **76.8** | 
...
**Projection Summary:** Most likely finish: **6 wins** | Projected PF: **1411** | Playoff: **0.0%** | #1 Seed: **0.0%** 

**Projection Breakdown (Avg Per Game, Weeks 13-15):** 
| Source | Projection | Notes | 
|--------|------------|-------| 
| ESPN Raw | 84.2 pts | ESPN projection (includes BYE/injured starters) | 
| **Optimized** | **75.9 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 90.4 | 87.3 | 
| Corrected (BYE/Inj=0) | 67.7 | 82.0 | 
| **Optimized (+Bench)** | **67.7** | **82.0** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 79.3 | 72.8 | 
| Corrected (BYE/Inj=0) | 71.3 | 61.2 | 
| **Optimized (+Bench)** | **81.7** | **65.6** | 
...
| **Optimized** | **50.8 pts** | ESPN Raw - unavailable + bench subs | 
...
|-----------------|--------|----------| 
| ESPN Raw | 84.7 | 109.5 | 
| Corrected (BYE/Inj=0) | 33.1 | 66.7 | 
| **Optimized (+Bench)** | **45.1** | **78.0** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 80.6 | 106.7 | 
| Corrected (BYE/Inj=0) | 70.2 | 52.2 | 
| **Optimized (+Bench)** | **87.8** | **52.2** | 
...
|-----------------|--------|----------| 
| ESPN Raw | 72.8 | 79.3 | 
| Corrected (BYE/Inj=0) | 61.2 | 71.3 | 
| **Optimized (+Bench)** | **65.6** | **81.7** | 
...
| 3 | sgf | 9.2 | 1630 | 8-4 | 73.5% |
| 4 | KIRK | 8.8 | 1600 | 7-5 | 60.8% |
| 5 | POO | 9.0 | 1557 | 7-5 | 51.9% |
| 6 | GV | 8.7 | 1547 | 7-5 | 35.4% |
| 7 | GEMP | 7.2 | 1435 | 6-6 | 1.3% |
| 8 | PATS | 6.5 | 1587 | 5-7 | 1.8% |
| 9 | KESS | 6.4 | 1411 | 5-7 | 0.0% |
